...
import { useLocation, useNavigate, Link, useMatch } from 'react-router-dom';
...
function ProfileDropdown({
  ...
  return (
    <div
      role="listbox"
      className="absolute right-0 top-full mt-1 z-50 w-[18rem] p-4 bg-white dark:bg-[#0d0d0d] border border-gray-300 dark:border-[#525252] shadow-none dark:shadow-lg outline-none overflow-hidden"
...
export default function DashboardHeader({
  ...
  // Match /project/:id/* or /projects/:id/*
  // We'll use /projects/:id/* for consistency with the mock data,
  // but if the URL is /project/:id, useMatch('/project/:id/*') works too.
    ...
    <>
      {location.pathname === '/settings' ? (
        <nav aria-label="Breadcrumbs" className={`flex-1 min-w-0 overflow-hidden [container-type:inline-size] h-full flex items-center ${isMobile ? 'px-4' : ''}`}>
          <ol className="flex m-0 p-0 w-full min-w-0 overflow-hidden">
            <li className="group/breadcrumb inline-flex items-center shrink-0 type-body-01">
              <Link className="flex items-center gap-2 py-1.5 px-2 hover:button-ghost-background--hover active:button-ghost-background--active breadcrumbs-text" to="/">
              ...
              <span aria-hidden="true" className="shrink-0 inline-flex items-center justify-center py-2 px-1.5 breadcrumbs-text--separator">
            ...
            <li className="group/breadcrumb inline-flex items-center shrink-0 type-body-01">
              <span className="text-primary flex items-center gap-2 py-1 ps-3 pe-2 type-body-01 breadcrumbs-text" aria-current="page">
        ...
        <nav aria-label="Breadcrumbs" className={`flex-1 min-w-0 overflow-visible [container-type:inline-size] ${isMobile ? '' : 'h-full flex items-center'}`}>
          <ol className="flex m-0 p-0 w-full min-w-0 overflow-visible items-center h-full">
  ...
  return (
    <>
      <header
        ...
        role="banner"
        className="shrink-0 sticky top-0 z-[30] w-full flex h-14 pe-3 sm:pe-4 bg-white dark:bg-[#090909] text-gray-900 dark:text-white border-b border-solid border-gray-300 dark:border-[#525252] transition-colors duration-300"
      >
      {/* Logo + workspace */}
      <div className="flex-shrink-0 inline-flex items-center gap-x-4 sm:gap-x-5 px-3 sm:px-4 h-full border-r border-gray-300 dark:border-[#525252] bg-white dark:bg-[#090909] transition-colors duration-300 w-[260px] md:w-[294px]">
        <div className="inline-flex items-center justify-center h-full sm:border-r border-gray-300 dark:border-[#525252] sm:pr-4 gap-x-1 sm:gap-x-0 transition-colors duration-300">
          <button 
            type="button" 
        ...
        <div className="flex-grow flex items-center justify-between h-full">
          ...
          <div className="me-4">
            <button type="button" className="text-[15px] font-medium text-gray-500 dark:text-[#a1a1aa] hover:bg-gray-100 dark:hover:bg-[#1a1a1a] hover:text-gray-900 dark:hover:text-white transition-colors h-9 py-1.5 px-3 focus:outline-none items-center hidden sm:flex group/button rounded-none">
              ...
              Search
              <kbd className="inline-flex items-center space-x-1 px-1 py-0.5 h-[22px] w-fit text-[12px] font-mono font-medium leading-none text-gray-500 dark:text-[#a1a1aa] bg-gray-100 dark:bg-[#1a1a1a] border border-gray-300 dark:border-[#525252] ms-2.5 rounded-none transition-colors duration-300">
      ...
      <div className="shrink-0 sm:hidden flex flex-nowrap items-center h-14 overflow-x-auto border-b border-solid border-gray-300 dark:border-[#525252] bg-white dark:bg-[#090909]">
