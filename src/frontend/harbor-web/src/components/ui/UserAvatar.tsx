...
export default function UserAvatar({
  ...
  if (svgString) {
    return (
      <span
        className={`flex-shrink-0 inline-flex items-center justify-center overflow-hidden border border-gray-300 dark:border-[#525252] rounded-sm ${className}`}
  ...
  return (
    <span
      className={`flex-shrink-0 flex items-center justify-center font-semibold leading-none capitalize border border-gray-300 dark:border-[#525252] rounded-sm ${colourClass} ${className}`}
