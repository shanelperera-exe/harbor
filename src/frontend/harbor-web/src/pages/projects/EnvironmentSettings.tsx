  ...
  return (
    <div className="w-full lg:max-w-[calc(100vw-294px)]">
      <main className="w-full max-w-[1920px] mx-auto px-4 mb-20 md:px-12">
        <div>
          <div className="my-6 md:my-12 flex justify-between">
            <div className="">
              <div className="">
                <h1 className="text-[36px] font-[500] leading-[40px] tracking-[-0.32px] text-strong text-gray-900 dark:text-white" style={{ fontFamily: 'Roobert, sans-serif' }}>Environment settings</h1>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-row-reverse gap-8">
            ...
            <div className="flex-1 space-y-10">
                        ...
                        <div id="name" className="grid grid-cols-1 xl:grid-cols-3 gap-y-4 xl:gap-y-0 xl:gap-x-10 scroll-mt-24">
                          <div className="col-span-1">
                            <div className="flex items-center">
                              <label htmlFor="name" className="inline-block text-gray-900 dark:text-[#f0f0f0] mb-1 text-[18px] font-semibold tracking-[0.16px] normal-case">Environment name</label>
                            </div>
                          </div>
                                ...
                                <div className="flex justify-end mt-4">
                                  {isEditing ? (
                                    <div className="flex items-center gap-3">
                                      <button type="button" onClick={() => { setIsEditing(false); setName(environment.name); }} className="h-10 py-2.5 px-3 flex items-center border border-solid border-gray-300 dark:border-[#525252] hover:bg-gray-100 dark:hover:bg-[#272727] text-gray-900 dark:text-[#f0f0f0] rounded-sm transition-colors">
                                        Cancel
                                      </button>
                                      <button type="submit" disabled={isSubmitting || name.trim() === environment.name || !name.trim()} className="h-10 py-2.5 px-4 flex items-center space-x-2 rounded-sm font-medium text-black bg-white hover:bg-gray-200 disabled:opacity-50 disabled:cursor-not-allowed transition-colors">
              ...
              <div id="delete-environment" className="scroll-mt-24 xl:scroll-mt-20 mt-12 pt-8 border-t border-gray-300 dark:border-[#525252]">
                ...
                <div className="border border-red-500 dark:border-red-600/50 rounded-sm overflow-hidden">
                  <div className="p-5 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white dark:bg-[oklch(0.21_0.03_263.45)]">
                    <div>
                      <h4 className="text-[16px] font-medium text-gray-900 dark:text-[#f0f0f0]">Delete Environment</h4>
      ...
      <DeleteConfirmationModal
        ...
        warningMessage={
          <>
            <p>This environment <span className="font-bold">{environment.name}</span> will be <span className="font-bold underline">permanently deleted</span>, along with all of its services.</p>
            <p className="mt-2">To keep any services, please move them out of the environment first.</p>
          </>
        }
        ...
        deleteButtonLabel="Delete environment"
      />
    </div>
  );
}
