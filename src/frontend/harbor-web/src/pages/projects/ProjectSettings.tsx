    ...
    <div className="w-full lg:max-w-[calc(100vw-294px)] page-primary transition-colors duration-300">
                          ...
                          <div className="flex flex-col">
                            <div className="flex relative">
                              <input
                                ...
                                className={'h-10 truncate type-interface-01 w-full m-0 py-2.5 px-3 border border-solid rounded-none appearance-none transition-colors ' + (isEditing ? 'input-background input-text border-gray-300 dark:border-[#525252] hover:border-gray-400 dark:hover:border-[#6b6b6b]' : 'input-background--readonly input-text--readonly border-gray-300 dark:border-[#525252] caret-transparent outline-none')}
                                type="text"
                                name="name"
                                readOnly={!isEditing}
                                value={name}
      ...
      {showDeleteModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" aria-modal="true" role="dialog">
          ...
          <div className="relative inline-block w-full my-8 text-left align-middle bg-white dark:bg-[#0d0d0d] shadow-lg border border-solid border-gray-300 dark:border-[#525252] max-w-2xl">
            {/* Modal Header */}
                  ...
                  <div className="flex flex-col">
                    <div className="flex relative">
                      <input
                        ...
                        autoComplete="off"
                        spellCheck={false}
                        className="h-10 truncate type-interface-01 w-full m-0 py-2.5 px-3 input-background placeholder:input-text--placeholder border border-solid border-gray-300 dark:border-[#525252] rounded-none appearance-none input-text outline-none"
                        type="text"
                        name="sudoCommand"
